...
/** @brief 最大解码通道数 */
#define DVR_MAX_DECODER_CHANNEL_NUM_CFG	(64)
/**************************************************************************
*								协议名称定义			                  *
**************************************************************************/
/** @brief 私有协议														*/
...
/** @brief UPNP 配置信息(HY_DVR_UPNP_CONF)										*/
#define NETCFG_UPNP_CONF					(1 << 18)
...
/** @brief 通道云台参数配置(HY_DVR_PTZPRO_CH_CFG)								*/
#define PTZCFG_FROM_CHANNEL					1
...
/** @brief PTZ补充配置(HY_DVR_PTZ_REPLENISH_1)									 */
#define SERIALCFG_PTZ_REPLENISH_1_CFG		2
/** @brief 云台遮蔽配置(HY_DVR_PTZ_SHIELD_SET)										 */ //20120426
#define PTZCFG_SHIELD							3
/** @brief 放大配置(HY_DVR_PTZ_REGION_ZOOM)										 */ //20120426
#define PTZCFG_REGION							4
///////////////////////////////////////////////////////////////////////////////////////////////////////
//主类型
/** @brief 获取报警配置参数														 */
...
//主类型
/** @brief 获取解码器显示设备信息												*/
#define	HY_DVR_GET_DECODER_CHANNEL_STATUS	147

/** @brief 设置解码器显示设备信息												*/
#define	HY_DVR_SET_DECODER_CHANNEL_STATUS	148

//次类型
/** @brief 所有解码器显示设备信息(HY_DVR_DECODER_CHANNEL_STATUS_CFG)			 */
...
/** @brief 非实时D1分辨率																		 */
#define	  DVR_CR_4CIF_SIM			0x10

/** @brief 非实时2CIF分辨率																		 */
#define   DVR_CR_2CIF_SIM			0x20
...
/*!
*  @struct	tagHY_DVR_PTZPRO_CH_CFG
*  @brief	通道云台协议管理信息
 */
typedef struct tagHY_DVR_PTZPRO_CH_CFG
{
	int bValid;																/*!< 本结构体是否有效，0表示无效 */
	HY_DVR_PTZPRO_CFG struPTZProCfg[DVR_MAX_VIDEOIN_NUM];					/*!< 云台协议信息  */

} HY_DVR_PTZPRO_CH_CFG, *LPHY_DVR_PTZPRO_CH_CFG;
/////////////////////////////////////////////////////////////////////////////////////////////////
...
/*!
*  @struct	HY_DVR_PTZ_TEMPERATURE_DEVICE
*  @brief	ptz温度设备配置
*/
typedef struct  tagHY_DVR_PTZ_TEMPERATURE_DEVICE
{
	int bValid;																/*!< 本结构体是否有效，0表示无效 */
...
*/
typedef struct  tagHY_DVR_PTZ_ELCTRONIC_CH_TEMPERATURE
{
	int bValid;																/*!< 本结构体是否有效，0表示无效 */
...
typedef struct tagHY_DVR_DECODER_CHANNEL
{
	...
	HY_DVR_PTZACTION struPTZAction;											/*!< 云台守望 */
...
*  @brief	ptz设备补充配置内容
*/
typedef struct  tagHY_DVR_PTZ_REPLENISH_CONTENT_1
{
	int bValid;																/*!< 本结构体是否有效，0表示无效 */
...
*  @brief	ptz设备补充配置
*/
typedef struct tagHY_DVR_PTZ_REPLENISH_1
{
	int bValid;																/*!< 本结构体是否有效，0表示无效 */
...
typedef struct tagHY_DVR_DISK
{
	...
	HY_DVR_DISK_TYPE struDiskType;											/*!< 存储设备类型 */
...
/*!
*  @struct	tagHY_DVR_DECODER_CHANNEL_STATUS
*  @brief	解码通道状态配置信息
*/
typedef struct tagHY_DVR_DECODER_CHANNEL_STATUS
{
	int bValid; 								/*!< 0表示无效 1表示有效 */

	char szSourceDeviceIP[DVR_MAX_IP_STR_LEN];	/*!< 前端设备 IP地址(只读)  */
	int nSourceDeviceChannel;					/*!< 前端设备 通道(只读) */
	int nVideoBitrate;							/*!< 网络流量 */
	int nStatus;								/*!< 0-空闲、1-实时解码、2-轮巡、3-回放、4-被动解码 */

} HY_DVR_DECODER_CHANNEL_STATUS,  * LPHY_DVR_DECODER_CHANNEL_STATUS;

/*!
*  @struct	tagHY_DVR_DECODER_CHANNEL_STATUS_CFG
*  @brief	解码通道状态配置
*/
typedef struct tagHY_DVR_DECODER_CHANNEL_STATUS_CFG
{
	int bValid; 								/*!< 0表示无效 1表示有效 */

	HY_DVR_DECODER_CHANNEL_STATUS	struDecoderChannel[DVR_MAX_DECODER_CHANNEL_NUM_CFG]; /*!< 解码通道状态配置 */

} HY_DVR_DECODER_CHANNEL_STATUS_CFG,  * LPHY_DVR_DECODER_CHANNEL_STATUS_CFG;
